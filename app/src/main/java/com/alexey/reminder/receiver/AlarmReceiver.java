package com.alexey.reminder.receiver;
...
import com.alexey.reminder.ChangeNoteActivity;
import com.alexey.reminder.PreferenceSettings;
...
import com.alexey.reminder.service.TextToSpeechService;
...
public class AlarmReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        PreferenceSettings settings = PreferenceSettings.getInstance(context);
        ...
        builder.setContentIntent(pendingIntent)
                .setSmallIcon(R.drawable.ic_application_white)
        ...
        if(settings.getBooleanItem(PreferenceSettings.VIBRATION)) {
            notification.defaults = Notification.DEFAULT_VIBRATE;
        }
        if(settings.getBooleanItem(PreferenceSettings.TEXT_SPEECH)){
